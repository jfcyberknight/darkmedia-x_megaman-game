...
{
  const c = C(8, 5)
  rect(c, 1, 1, 7, 3, hex(0xff2436))
  rect(c, 2, 1, 6, 3, hex(0xff6b5e))
  rect(c, 3, 2, 5, 2, hex(0xffe2e2))
  save(c, 'bullet.png')
  const m = C(10, 7)
  ell(m, 5, 3.5, 4.5, 2.8, hex(0xff2436))
  ell(m, 5, 3.5, 3, 1.8, hex(0xff6b5e))
  rect(m, 4, 3, 6, 4, hex(0xffe2e2))
  save(m, 'bullet-mid.png')
  const g = C(14, 10)
  ell(g, 7, 5, 6.5, 4.5, hex(0xff2436))
  ell(g, 7, 5, 5, 3.4, hex(0xff6b5e))
  ell(g, 7, 5, 3, 2, hex(0xffd6d6))
  rect(g, 6, 4, 8, 6, hex(0xffe2e2))
...
const STAGE_ART = {
  ...
  'frost-lab': { far: [0x0c1a30, 0x060c18], mid: [0x081426, 0x040a12], window: 0x9fd8ff, windowAlt: 0x60a5fa, sign: [0x60a5fa, 0xcfe8ff] },
